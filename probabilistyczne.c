...
//// W TEN SPOSOB SPRAWDZAM RNG VS. ZLICZANIE
//// WYNIKI: ALBO RNG JEST NAPRAWDE SKRZYWIONE, ALBO WERSJA PROBABILISTYCZNA ZAWIERA JAKIES BLAD
//// ZMIANY ANG/PL NIE PRZENOSZA ZADNEGO ZNACZENIA
